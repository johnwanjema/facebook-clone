...
function StoryCard({name, src, profile}) {
    return (
        ...
        transform ease-in hover:scale-105 hover:animate-pulse">
            ...
            src={profile} width={40} height={40} layout="fixed" objectFit="cover" />
            
            <Image className="object-cover filter brightness-75 rounded-full
            lg:rounded-3xl" src={src} layout="fill"/>
